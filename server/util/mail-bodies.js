export const htmlMailBody = (content) => `<!DOCTYPE html>
<html>
  <head>
                      ...
                      <table  class="w640"  width="640" cellpadding="0" cellspacing="0" border="0">
                        <tbody>
                          <tr>
                            ...
                            <td  class="w580"  width="580" valign="middle" align="left"></td>
                            <td class="w30"  width="30"></td>
                          </tr>
                        </tbody>
                      </table>
...
export const magicLinkHtmlMailBody = (content, magicLinkUrl) => `<!DOCTYPE html>
<html>
  <head>
  <title>Email de Candilib</title>
  <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
